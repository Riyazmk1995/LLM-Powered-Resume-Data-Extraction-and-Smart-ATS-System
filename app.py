...
Hey, act like a skilled or very experienced ATS (Application Tracking System) with a deep understanding of tech fields such as software engineering, data science, machine learning, deep learning, artifical intelligence, generative ai, data analytics, and big data engineering. Your task is to evaluate the resume and extract data into the following structure:
...
input_prompt_ats = """
Hey Act Like a skilled or very experienced ATS (Application Tracking System) with a deep understanding of tech fields such as software engineering, data science, machine learning, deep learning, artifical intelligence, generative ai, data analytics, and big data engineering. Your task is to evaluate the resume based on the given job description. You must consider the job market is very competitive and you should provide the best assistance for improving the resumes. Assign the percentage matching based on JD and the missing keywords with high accuracy.
